...
<html lang="fr">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">{{ucwords($categorie->name)}}</h1>           
        </div>
        <!-- Single Page Header End -->
         ...
         <div class="container-fluid fruite py-5">
            <div class="container py-5">
                <h2 class="mb-4">Recherche pour <i>{{$categorie->name}}</i></h2>
                <div class="row g-4">
                    <div class="col-lg-12">                       
                        <div class="row g-4">
                            <div class="col-lg-3">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="{{route('categories.show',['id'=>$cat->id]) }}"><i class="fas fa-shop me-2"></i>{{$cat->name}}</a>
                                                        <!-- <span>(3)</span> -->
                                                    </div>
                                                </li>   
                                                @endforeach                                  
                            ...
                            <div class="col-lg-9">
                                ...
                                @if($categorie->id == $art->category_id)
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{asset('storage/'.$art->image)}}" class="img-fluid w-100 rounded-top" alt="{{$art->title}}">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">{{$categorie->name}}</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>{{$art->title}}</h4>
                                                <p>{{$art->stock}}</p>
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0">{{$art->price}} Fcfa</p>
                                                    <a href="{{route('article.view', $art->slug)}}" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-eye me-2 text-primary"></i> Consulter</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
