                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            <a class="btn-link" href="{{route('apropos')}}" target="_blank">A propos </a>
                            <a class="btn-link" href="{{route('contact')}}">Contact Us</a>
                            <a class="btn-link" href="{{route('politique')}}" target="_blank">Privacy Policy</a>
                            <a class="btn-link" href="{{route('politique')}} "target="_blank">Terms & Condition</a>
