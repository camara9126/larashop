...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assetsD/vendors/css/vendor.bundle.base.css')}}">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="{{asset('assetsD/vendors/font-awesome/css/font-awesome.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('assetsD/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css')}}"/>
